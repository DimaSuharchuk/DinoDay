 ...
 */
function dino_preprocess_html(&$variables) {
}

/**
 * Implements template_preprocess_page.
 */
function dino_preprocess_page(&$variables) {
}

/**
 * Implements template_preprocess_node.
 */
function dino_preprocess_node(&$variables) {
}
...
function dino_preprocess_dinosaur_info(&$variables) {
  ...
  $variables['style'] = _get_dinosaur_style_by_id($id);

  $variables['life'] = $current_dinosaur['life'];
...
function dino_preprocess_dinosaur_undefined_info(&$variables) {
  ...
  $variables['grade'] = $variables['dinosaur_entity']->grade;
  $variables['style'] = _get_dinosaur_style_by_id($variables['dinosaur_entity']->id);
}
